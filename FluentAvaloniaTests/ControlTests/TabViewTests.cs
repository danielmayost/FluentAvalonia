    ...
    public class TabViewTests : IClassFixture<TabViewTestsContext>
    {
        ...
        public void AddTabButtonFiresAddTabButtonClickEvent()
        {
            ...
            var button = Context.TabView.GetVisualDescendants()
                .OfType<FluentAvalonia.UI.Controls.Button>()
        ...
        public void TabViewItemCloseButtonOverlayModeWorks()
        {
            ...
            secondItem.RaiseEvent(new PointerEventArgs(InputElement.PointerEnteredEvent, button, null, Context.Root, new Point(), 0, null, KeyModifiers.None));
            Assert.True(button.IsVisible);
            secondItem.RaiseEvent(new PointerEventArgs(InputElement.PointerReleasedEvent, button, null, Context.Root, new Point(), 0, null, KeyModifiers.None));

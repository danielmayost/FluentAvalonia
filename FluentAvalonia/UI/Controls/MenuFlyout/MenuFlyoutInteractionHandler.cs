...
namespace FluentAvalonia.UI.Controls
{
	...
	internal class MenuFlyoutInteractionHandler : IMenuInteractionHandler
	{
		...
		public virtual void Attach(MenuFlyoutPresenter menu)
		{
			...
			Menu.AddHandler(MenuItem.PointerReleasedEvent, PointerReleased);
		...
		public virtual void Detach(IMenu menu)
		{
			...
			Menu.RemoveHandler(MenuItem.PointerReleasedEvent, PointerReleased);
		...
		protected internal virtual void PointerReleased(object sender, PointerEventArgs e)
		{
			var item = GetMenuItem(e.Source as IControl);

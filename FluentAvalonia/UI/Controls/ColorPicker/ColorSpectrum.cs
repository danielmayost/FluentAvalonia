	...
	public partial class ColorSpectrum : ColorPickerComponent
    {
		...
		public override void Render(DrawingContext context)
        {
			...
			using (context.PushClip(new Rect(Bounds.Size)))
            {
                ...
                {
                    context.DrawImage(_tempBitmap, new Rect(_tempBitmap.Size), rect, Avalonia.Media.Imaging.BitmapInterpolationMode.HighQuality);
                ...
                {					
					...
					using (context.PushOpacity(Color.Valuef))
						context.DrawImage(_tempBitmap, new Rect(_tempBitmap.Size), _lastWheelRect, Avalonia.Media.Imaging.BitmapInterpolationMode.HighQuality);
				}
